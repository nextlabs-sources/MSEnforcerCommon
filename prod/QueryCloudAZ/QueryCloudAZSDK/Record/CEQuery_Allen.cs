...
namespace QueryCloudAZSDK
{
    ...
    public class CEQuery
    {
        ...
        public CEQuery(string strPCHost, string strOAuthServiceHost, string strClientId, string strClientSecret, int nExpiresIn = 10)
        {
            Init(strPCHost, strOAuthServiceHost, strClientId, strClientSecret, nExpiresIn);
        }
        /// <summary>
        ...
        public CEQuery(string strJPCConfigFilePath, int nExpiresIn = 10)
        {
            ...
            if (bRet)
            {
                Init(obJPCConfigIns.JPCHost, obJPCConfigIns.OAuthHost, obJPCConfigIns.ClientID, obJPCConfigIns.ClientSecure, nExpiresIn);
            }
            else
            {
        ...
        private void Init(string strPCHost, string strOAuthServiceHost, string strClientId, string strClientSecret, int nExpiresIn = 10)
        {
