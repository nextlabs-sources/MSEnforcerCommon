...
private:
    ...
    vector<wstring> InnerGetTagValueByName(_In_ const wstring& kwstrTagName) const;
    ...
    vector<wstring> GetVectorTagValuesFromStringTagValue(_In_ const wstring& kwstrTagValue) const;
