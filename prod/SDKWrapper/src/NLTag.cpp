...
vector<wstring> CNLTag::InnerGetTagValueByName(_In_ const wstring& kwstrTagName) const
{
...
vector<wstring> CNLTag::GetVectorTagValuesFromStringTagValue(_In_ const wstring& kwstrTagValue) const
{
    vector<wstring> vecTagValues;
    if (m_kstrTagValueSeparator.empty())
    {
