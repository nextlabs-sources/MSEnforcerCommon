 ...
 * ADVANCED CONDITION
 * */
typedef enum { PE_STRING_LIST, PE_SUBJECT, PE_HOST, PE_APPLICATION, PE_RESOURCE } POLICY_ENGINE_HANDLE_TYPE;
 ...
 * */
typedef enum { PE_NO_MATCHED = 0, PE_NEED_MORE_WORK /* todo */ } POLICY_ENGINE_MATCH_RESULT;
