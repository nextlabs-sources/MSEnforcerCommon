...
public class EncryptProjectFile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<JsonProject> projects = manager.listProjects(null, true);
        for (JsonProject project : projects) {
        	System.out.println("Project Name: " + project.getName() + " Tenant Name: " + project.getTenantName());
        }
        ...
        manager.encrypt(inputFile, outputFile, null, null, tagMap, project.getTenantName());
